    ...
    return (
        <div>
            <ul className="staffSideBar">
                    ...
                    if (staff.rank === "owner") {
                        return (
                            <li key={staff.username}>
                                <NavLink end to={`/staff/${staff.username}`}>
                                    <button className="staffSideButton">
                                        {staff.username}
                                    </button>
                                </NavLink>
                            </li>
                ...
                <li className="staffSideBarTitle">SR ADMINS</li>
                {staff.map((staff) => {
                    if (staff.rank === "sradmin") {
                        return (
                            <li key={staff.username}>
                                <NavLink to={`/staff/${staff.username}`}>
                                    <button className="staffSideButton">
                                        {staff.username}
                                    </button>
                                </NavLink>
                ...
                <li className="staffSideBarTitle">JR MODS</li>
                {staff.map((staff) => {
                    if (staff.rank === "jrmod") {
                        return (
                            <li key={staff.username}>
